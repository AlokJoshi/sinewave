(function () {
  ...
  function draw() {
    ...
    //here we draw lines to define the shape of
    //the wave..that is we are drawing small line from one
    //end of the wave to another. Once we get to x=0
    //we draw a line from there to 0,screenHeight and then
    //calling fill will close the shape and that entire shape
    //will get filled with the gradient color!!
